...
- Admin は全データの**閲覧権限**を持つが、他人のレポートの**編集・承認は不可**
...
**凡例**: ○ = 許可、× = 禁止、※ = 所有権条件付き許可、△ = 関連リソース条件付き許可
...
| **Admin の編集不可** | Admin は全レポートを閲覧できるが、他人のレポートは編集・承認・却下できない | 不正改ざん防止 |
